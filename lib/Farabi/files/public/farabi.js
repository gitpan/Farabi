...
function StartFarabi(editorId) {
	...
	$help_dialog.dialog({autoOpen: false, title: "Help"});
	$help_search_dialog.dialog({autoOpen: false, title: "Help Search", width: 600});
	...
	$("#help_dialog_selector").mouseover(function() {
		$(this).animate({
			opacity: 1.0,
		});
